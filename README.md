...
> It is hard to solve our persistent problems in Birmingham, despite our efforts. We must be missing something important.

Each team chooses one primary user, one repeated moment of friction, and one observable outcome, then builds the smallest useful artifact that makes that moment meaningfully better. Projects may be software or another useful civic artifact — a service blueprint, research artifact, implementation plan, campaign, or operating process. Every project must leave a visible artifact, clear limitations, and a named next step.

## What's in this repo

| File | Purpose |
|---|---|
| [SCHEDULE.md](SCHEDULE.md) | Full day-of schedule |
| [RULES.md](RULES.md) | Rules, safety, and data guidelines |
| [SUBMISSIONS.md](SUBMISSIONS.md) | What to submit and how |
| [JUDGING.md](JUDGING.md) | Scoring rubric and finalist/winner selection |
| [TEAM_ASSIGNMENTS.md](TEAM_ASSIGNMENTS.md) | Provisional team IDs and challenge assignments |
| [templates/TEAM_README_TEMPLATE.md](templates/TEAM_README_TEMPLATE.md) | Copy this into your team's project repo |
| `.github/ISSUE_TEMPLATE/project-submission.yml` | Submission form (opened as a GitHub Issue) |
...
- The winning team receives Claude 20x accounts for one month.
- Attendees receive $100 in API credits.
...
1. Read [RULES.md](RULES.md) and [JUDGING.md](JUDGING.md) before you start building.
